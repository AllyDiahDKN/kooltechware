            ...
            <div class="header-lower">
                <div class="auto-container">
                    <div class="outer-box">
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix home-menu">
                                        ...
                                        <li><a href="shop.php">Lenovo</a></li>
                                    
                                   
                                        <li><a href="shop.php">Printers</a></li>
                                        
                                 
                                        <li><a href="shop.php">Toners</a></li>
                        ...
                        <div class="btn-box">
                            <a href="index.php" class="theme-btn theme-btn-one">Get A Quote<i class="icon-4"></i></a>
                        </div>
                    </div>
                </div>
            </div>

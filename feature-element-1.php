...
<!-- Mirrored from html.tonatheme.com/2023/atrix/feature-element-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Feb 2024 19:40:21 GMT -->
<head>
<meta charset="utf-8">
    ...
    <div class="boxed_wrapper">
        ...
        <div class="loader-wrap">
            <div class="preloader">
                ...
                <div id="handle-preloader" class="handle-preloader faq-page">
        ...
        <section class="page-title about-page-5 style-two p_relative centred">
            ...
            <div class="auto-container">
                <div class="content-box">
                    <h1 class="d_block fs_60 lh_70 fw_bold mb_10">Elements</h1>
                    <ul class="bread-crumb p_relative d_block mb_8 clearfix">
                        <li class="p_relative d_iblock fs_16 lh_25 fw_sbold font_family_inte mr_20"><a href="index.html">Home</a></li>
                        <li class="p_relative d_iblock fs_16 lh_25 fw_sbold font_family_inte mr_20">Elements</li>
                        <li class="current p_relative d_iblock fs_16 lh_25 fw_sbold font_family_inte">Feature Column 01</li>
                    </ul>
                </div>
            </div>
        </section>
...
?>
                    <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                        <div class="feature-block-one wow fadeInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_100 pr_50 pt_11 pb_9">
                                <div class="icon-box p_absolute l_0 t_0 w_80 h_80 lh_80 b_radius_50 text-center fs_45 z_1">
                                    <div class="icon p_relative d_iblock g_color"><?php     echo '<i class="icon-' . $i . '"></i>' . PHP_EOL;?></div>
                                </div>
                            </div>
                        </div>
                    </div>

...
if ($productResult) {
    while ($product = mysqli_fetch_assoc($productResult)) {
        ...
        echo '<li><a href="shop-details.html"><i class="icon-155"></i></a></li>';
        echo '<li><a href="shop.html"><i class="icon-154"></i></a></li>';
        echo '<li><a href="shop-details.html"><i class="icon-140"></i></a></li>';
        echo '</ul>';
        echo '</div>';
